...
export async function getLocationAsync(
    accuracy: Location.Accuracy = Config.DEFAULT_ACCURACY): Promise<Location.LocationData> {
...
// export function latLngToS2(lat: number, lng: number, level: number = Config.DEFAULT_S2_LEVEL): string {
//   return S2.latLngToKey(lat, lng, level)
// }

// export function locationDataToS2(locationData: Location.LocationData,
//     level: number = Config.DEFAULT_S2_LEVEL): string {
